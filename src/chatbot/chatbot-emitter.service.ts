...
export class ChatbotEmitterService {
  ...
  async triggerScreenBreakReminders() {
  ...
  async triggerCodeBreakReminders() {
  ...
  async triggerCreativeDigestReminders() {
  ...
  async triggerPostureCheckReminders() {
  ...
  async triggerDeepBreathingReminders() {
  ...
  async triggerStretchBreakReminders() {
  ...
  async triggerMentalHealthCheckins() {
  ...
  private async triggerReminderForAllUsers(reminderType: TypeofReminder) {
    const activeUsers = await this.userRepo.find({
      where: { is_active: true },
    });
  ...
  async triggerManualCheckin(userId: number, checkinType: CheckinType) {
  ...
  async triggerManualReminder(userId: number, reminderType: TypeofReminder) {
  ...
  async triggerBurnoutAssessment(userId: number) {
